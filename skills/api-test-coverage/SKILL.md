...
3. **Category coverage** — distribution across positive/negative/boundary/security/idempotency (`enum` and `format` are reserved for a future release; not yet generated by `gen`)
